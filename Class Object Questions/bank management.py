class BankAccount:
    ...
    def deposit(self, amount):
        self.balance += amount
        return f"Deposit of {amount} Rs. successful. New balance: {self.balance} Rs."

    def withdraw(self, amount):
        if amount <= self.balance:
            self.balance -= amount
            return f"Withdrawal of {amount} Rs. successful. New balance: {self.balance} Rs."
        else:
...
class SavingsAccount(BankAccount):
    ...
    def apply_interest(self):
        ...
        return f"Interest of {interest_earned} Rs. applied. New balance: {self.balance} Rs."
...
# Example usage:
savings_account = SavingsAccount(account_number=1, owner="Alok", balance=10000)
checking_account = CheckingAccount(account_number=2, owner="Manish", balance=8000)
